...
// Test for Kataloge > Telefonarten

test.describe('Kataloge - Telefonarten', () => {
  test('should login, navigate to Telefonarten, and add data', async ({ page }) => {
    ...
    await page.locator('a.sidebar--menu-item[title="Telefonarten"]').click();

    // Verify we're on the Telefonarten page by checking for a specific element
    await page.waitForSelector('text=Telefonarten', { timeout: 2000 });
    
    // Click the '+' button to add a new Telefonart
    ...
    await bezeichnungInput.fill('Test Telefonart');
    ...
    if (!keepTestData) {
        ...
        const postSaveCheckbox = page.locator('xpath=/html/body/div/div/div[3]/div[2]/div/div[3]/div/div[2]/div[2]/div[8]/div[1]/input');
